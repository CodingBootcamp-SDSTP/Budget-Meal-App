...
CREATE TABLE foodplaces_tbl (
	fpid INT PRIMARY KEY AUTO_INCREMENT, fpphoto VARHCAR(255), fpname VARCHAR(255) NOT NULL, fplocation VARCHAR(255) NOT NULL, fpmenuname VARCHAR(255) NOT NULL, fpmenuprice DECIMAL(4, 2) NOT NULL
);
...
INSERT INTO foodplaces_tbl (fpphoto, fpname, fplocation, fpmenuname, fpmenuprice) VALUES (NULL, 'Lugaw Queen', 'Balibago', 'grilled pork bbq', 65.00);
INSERT INTO foodplaces_tbl (fpphoto, fpname, fplocation, fpmenuname, fpmenuprice) VALUES (NULL, 'Overflowings', 'Balibago', 'fried chicken wings', 99.00);
